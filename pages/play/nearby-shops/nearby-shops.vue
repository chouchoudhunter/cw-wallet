<template>
	<view>
		...
		<view class="shop-nav">
			<!-- 导航栏 -->
			<view :class="{'style-red': menuActive[0]}" class="style-black" ref="pop" @click="goActiveList(0)">人气商家</view>
			<view :class="{'style-red': menuActive[1]}" class="style-black" @click="goActiveList(1)">品牌商家</view>
			<view :class="{'style-red': menuActive[2]}" class="style-black" @click="goActiveList(2)">推荐商家</view>
			<view :class="{'style-red': menuActive[3]}" class="style-black" @click="goActiveList(3)">最新入驻</view>
			<view :class="{'style-red': menuActive[4]}" class="style-black" @click="goActiveList(4)">距离最近</view>
		</view>
